...
% Julies. 
clearvars
fname = 'grid_case2_finergrid03_slope5_ale.nc';
%% ADDITION FROM JW
% for all use:
    spherical='F';
    projection='mercator';
...
slope_sea     = 2.5e-4;             % seaward slope
...
%     rout(1).X = (Lp) * ones(ns1,1);
    ...
    rout(1).salt =  24;                       % RIVER SALINITY CHANGE HERE
    rout(1).dye  =  1;
    rout(1).Qf   = 1000;
...
% We would probably have to change here for a "realistic slope
depth_max = 150;
